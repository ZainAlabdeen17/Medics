...
class XRaysView extends StatefulWidget {
  const XRaysView({super.key});

  @override
  State<XRaysView> createState() => _XRaysViewState();
}

class _XRaysViewState extends State<XRaysView> {
      ...
      child: Scaffold(
        body: SafeArea(
          child: RefreshIndicator(
            onRefresh: () async {
              await context.read<MedicalTestsCubit>().getXRays();
            },
            ...
            child: Padding(
              ...
              child: CustomScrollView(
                slivers: [
                  SliverToBoxAdapter(
                    child: GeneralHeader(title: AppStrings.xRays),
                  ),
                  SliverToBoxAdapter(child: SizedBox(height: 8.h)),
                  SliverToBoxAdapter(
                    child: HomeSearchField(
                      hintText: AppStrings.startTypingXRayName,
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: SvgPicture.asset(
                                      Assets
                                          .assetsImagesIconsSpecializatiosPulmonologist,
                                    ),
                                  ),
                                  ...
                                  SizedBox(height: 8.h),
                                  Text(
                                    'Your X-Rays will appear here once they are available.',
